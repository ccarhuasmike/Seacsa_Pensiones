...
Begin VB.Form Frm_EndosoHerencia 
   ...
   Begin VB.Frame Fra_Operacion 
      ...
      Begin VB.CommandButton Cmd_Imprimir 
         ...
         Height          =   675
         Left            =   3600
         Picture         =   "Frm_Endoso_herencia.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   23
         Top             =   240
         Width           =   720
      ...
      Begin VB.CommandButton Cmd_Limpiar 
         ...
         Height          =   675
         Left            =   4560
         Picture         =   "Frm_Endoso_herencia.frx":0AFC
         Style           =   1  'Graphical
         TabIndex        =   22
      ...
      Begin VB.CommandButton Cmd_Cancelar 
         ...
         Height          =   675
         Left            =   5280
         Picture         =   "Frm_Endoso_herencia.frx":15F8
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   240
         Width           =   720
      ...
      Begin VB.CommandButton Cmd_Salir 
         ...
         Height          =   675
         Left            =   6120
         Picture         =   "Frm_Endoso_herencia.frx":1BD2
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton Cmd_Grabar 
         ...
         Height          =   675
         Left            =   2760
         Picture         =   "Frm_Endoso_herencia.frx":1CCC
         Style           =   1  'Graphical
         TabIndex        =   20
      ...
      Begin VB.CommandButton Cmd_Eliminar 
         ...
         Height          =   675
         Left            =   3720
         Picture         =   "Frm_Endoso_herencia.frx":2386
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   4440
         Visible         =   0   'False
      ...
      Begin VB.CommandButton Cmd_Aprobar 
         ...
         Height          =   675
         Left            =   2760
         Picture         =   "Frm_Endoso_herencia.frx":26C8
         Style           =   1  'Graphical
         TabIndex        =   5
         ToolTipText     =   "Grabar Datos"
         Top             =   240
   ...
   Begin VB.Frame Fra_Poliza 
      ...
      Begin VB.CommandButton Cmd_BuscarPendiente 
         ...
         Height          =   680
         Left            =   8640
         Picture         =   "Frm_Endoso_herencia.frx":2D82
         Style           =   1  'Graphical
         TabIndex        =   24
      ...
      Begin VB.CommandButton Cmd_BuscarPol 
         Height          =   705
         Left            =   7920
         Picture         =   "Frm_Endoso_herencia.frx":2E84
         Style           =   1  'Graphical
         TabIndex        =   1
         ToolTipText     =   "Buscar Póliza"
         Top             =   180
   ...
   Begin TabDlg.SSTab SSTab_PolizaModificada 
      ...
      TabPicture(0)   =   "Frm_Endoso_herencia.frx":2F86
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "Fra_PM"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Beneficiarios a Endosar"
      TabPicture(1)   =   "Frm_Endoso_herencia.frx":2FA2
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "Msf_BMGrilla"
      Tab(1).Control(1)=   "frmDatosGen"
      Tab(1).Control(2)=   "Fra_BM"
      Tab(1).Control(3)=   "Cmd_BMSumar"
      Tab(1).Control(4)=   "Cmd_BMRestar"
      Tab(1).Control(5)=   "Cmd_BMCalcular"
      Tab(1).ControlCount=   6
      Begin VB.CommandButton Cmd_BMCalcular 
         Enabled         =   0   'False
         Height          =   450
         Left            =   -66300
         Picture         =   "Frm_Endoso_herencia.frx":2FBE
         Style           =   1  'Graphical
         TabIndex        =   144
      ...
      Begin VB.CommandButton Cmd_BMRestar 
         ...
         Height          =   450
         Left            =   -66300
         Picture         =   "Frm_Endoso_herencia.frx":3580
         Style           =   1  'Graphical
         TabIndex        =   143
      ...
      Begin VB.CommandButton Cmd_BMSumar 
         ...
         Height          =   450
         Left            =   -66300
         Picture         =   "Frm_Endoso_herencia.frx":370A
         Style           =   1  'Graphical
         TabIndex        =   142
      ...
      Begin VB.Frame Fra_BM 
         ...
         Begin VB.ComboBox cmbExcluesion 
            ...
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "Frm_Endoso_herencia.frx":3894
            Left            =   1080
            List            =   "Frm_Endoso_herencia.frx":38A1
            Style           =   2  'Dropdown List
            TabIndex        =   125
            Top             =   1260
            Width           =   3135
   ...
   Begin VB.Frame Frame1 
      ...
      Top             =   1080
      Width           =   9375
      Begin VB.Frame frm_rangoFechas 
         ...
         Begin MSComctlLib.ProgressBar BarraProgreso 
            ...
            Appearance      =   1
         End
         Begin VB.CommandButton cmdAceptaRangFecha 
            Caption         =   "Aceptar"
            Height          =   375
            Left            =   1080
            TabIndex        =   165
         ...
         End
      End
      Begin VB.TextBox txtfuturasnopagadas 
         Height          =   375
         Left            =   6600
         TabIndex        =   173
         Top             =   720
      ...
      Begin VB.TextBox txtMemo 
         ...
         Width           =   2055
      End
      Begin VB.TextBox txtSucesionIntes 
         Height          =   375
         Left            =   2160
         TabIndex        =   158
         Top             =   1680
      ...
      Begin VB.TextBox TxtFecPago 
         ...
         Width           =   1785
      End
      Begin VB.TextBox txtPer_garantizado 
         Enabled         =   0   'False
         Height          =   285
         Left            =   7920
         MaxLength       =   13
      ...
      Begin VB.Label Label25 
         Caption         =   "Pensiones futuras no pagadas"
         Height          =   375
         Left            =   4320
         TabIndex        =   171
         Top             =   720
...
Private Type Datos_herencia
    num_poliza As String
    num_endoso As Integer
    Num_IdenBen As String
    nombres As String
    mto_pensioncal As Double
    fecha_solicita As String
    fec_pago As String
    Cod_UsuarioCrea As String
    Estado As String
    sucesion As String
    cod_memo As String
    Pens_no_pagadas As Double
    Pens_futuras_no_pagadas As Double
    per_garantizado As Integer
    fecha_crea As String

End Type

Dim oDat() As Datos_herencia

Private Sub cargaDatos_Herencia(ByVal pnum_poliza As String)
                ...
                objCmd.CommandText = "Pkg_EndososHerencia.Obtener_endosoXPoliza"
                ...
                If rs.RecordCount > 0 Then
                    ...
                    While Not rs.EOF
                      i = i + 1
                          ...
                          oDat(i).num_poliza = IIf(IsNull(rs!num_poliza), "", rs!num_poliza)
                          oDat(i).num_endoso = IIf(IsNull(rs!num_endoso), 0, rs!num_endoso)
                          oDat(i).Num_IdenBen = IIf(IsNull(rs!Num_IdenBen), "", rs!Num_IdenBen)
                          oDat(i).nombres = IIf(IsNull(rs!nombres), "", rs!nombres)
                          oDat(i).mto_pensioncal = IIf(IsNull(rs!mto_pensioncal), 0, rs!mto_pensioncal)
                          oDat(i).fecha_solicita = IIf(IsNull(rs!fecha_solicita), "", rs!fecha_solicita)
                          oDat(i).fec_pago = IIf(IsNull(rs!fec_pago), "", rs!fec_pago)
                          oDat(i).Cod_UsuarioCrea = IIf(IsNull(rs!Cod_UsuarioCrea), "", rs!Cod_UsuarioCrea)
                          oDat(i).Estado = IIf(IsNull(rs!Estado), "", rs!Estado)
                          oDat(i).sucesion = IIf(IsNull(rs!sucesion), "", rs!sucesion)
                          oDat(i).cod_memo = IIf(IsNull(rs!cod_memo), "", rs!cod_memo)
                          oDat(i).Pens_no_pagadas = IIf(IsNull(rs!Pens_no_pagadas), 0, rs!Pens_no_pagadas)
                          oDat(i).Pens_futuras_no_pagadas = IIf(IsNull(rs!pens_fut_no_pagadas), 0, rs!pens_fut_no_pagadas)
                          oDat(i).per_garantizado = IIf(IsNull(rs!per_garantizado), 0, rs!per_garantizado)
                ...
                txtSucesionIntes.Enabled = False
                txtMemo.Enabled = False
                txtmto_pensioncal.Enabled = True
                txtgls_docjud.Enabled = True
                TxtFecPago.Enabled = True
                txtnopagadas.Enabled = True
                txtfuturasnopagadas.Enabled = True
                    
                           
                    Txt_PenNumIdent = oDat(0).Num_IdenBen
                    Lbl_PenNombre = oDat(0).nombres
                    txtmto_pensioncal = Format(oDat(0).mto_pensioncal, "###,##0.00")
                    txtgls_docjud = oDat(0).fecha_solicita
                    TxtFecPago = oDat(i).fec_pago
                    txtSucesionIntes = oDat(i).sucesion
                    Lbl_BMNumOrd = oDat(i).num_endoso
                    txtMemo.Text = oDat(i).cod_memo
                    txtnopagadas = Format(oDat(0).Pens_no_pagadas, "###,##0.00")
                    txtfuturasnopagadas = Format(oDat(0).Pens_futuras_no_pagadas, "###,##0.00")
                    Me.txtPer_garantizado.Text = oDat(i).per_garantizado
...
Dim vgQuery As String
Dim SwRegNuevo As Boolean

SwRegNuevo = True


vgQuery = "select count(1) as cuenta from pp_tmae_poliza where num_poliza= '" & Txt_PenPoliza.Text & "' and ind_heren=2"

    Set RSV = New ADODB.Recordset

    
       Set RSV = vgConexionBD.Execute(vgQuery)
 
    
    If Not RSV.EOF Then
        If RSV!CUENTA > 0 Then
              'MsgBox "La póliza ya tiene un endoso por herencia", vbCritical, "Error de Datos"
...
If txtPer_garantizado = 0 Then

    MsgBox "La póliza no tiene periodo garantizado", vbCritical, "Error de Datos"
    Exit Sub
End If
...
If Not IsNumeric(txtnopagadas.Text) Then
    MsgBox "Debe ingresar las pensiones no pagadas. Edite y realice los cambios", vbCritical, "Error de Datos"
    Exit Sub
End If

'If Val(txtnopagadas.Text) < 1 Then
'    MsgBox "Las pensiones no pagadas debe ser mayor a cero. Edite y realice los cambios", vbCritical, "Error de Datos"
'    Exit Sub
'End If

If Not IsNumeric(txtfuturasnopagadas.Text) Then
    MsgBox "Debe ingresar las pensiones futuras no pagadas. Edite y realice los cambios", vbCritical, "Error de Datos"
    Exit Sub
End If

'If Val(txtfuturasnopagadas.Text) < 1 Then
'    MsgBox "Las pensiones futuras no pagadas debe ser mayor a cero. Edite y realice los cambios", vbCritical, "Error de Datos"
'    Exit Sub
'End If
...
If txtMemo.Text = "" Then
 MsgBox "Debe ingresar el Memo. Edite y realice los cambios", vbCritical, "Error de Datos"
    txtMemo.SetFocus
    Exit Sub
End If
...
If CDate(Me.TxtFecPago) < CDate(txtgls_docjud.Text) Then
    MsgBox "La fecha de pago no puede ser menor a la fecha de solicitud.", vbInformation, "Error de Datos"
    Me.TxtFecPago.SetFocus
    Exit Sub
End If
...
If SwRegNuevo Then
    msje = "¿ Está seguro que desea Aprobar Definitivamente ?"
Else
    msje = "¿ Está seguro de actualizar el endoso ?"
End If
 
vgRes = MsgBox(msje, 4 + 32 + 256, "Operación de Aprobación")
If vgRes <> 6 Then
    Cmd_Salir.SetFocus
    Screen.MousePointer = 0
    Exit Sub
End If
 ...
 If (fl_aprobar(SwRegNuevo) = True) Then
        If SwRegNuevo Then
            MsgBox "El Procedimiento de Aprobación se realizó Correctamente.", vbInformation, "Proceso Finalizado"
        Else
            MsgBox "El endoso de Herencia se actualizó Correctamente.", vbInformation, "Proceso Finalizado"
        End If
        
        Call Cmd_Cancelar_Click
        Me.Txt_PenPoliza.SetFocus
 ...
 End If
End Sub
Private Function Registra_Endoso(ByVal pnum_poliza As String, _
                      ByVal pmemo As String, _
                      ByVal pnum_endoso As Integer, _
                      ByVal pnum_perpago As String, _
                      ByVal pfecha_sol As String, _
                      ByVal pfecha_pago As String, _
                      ByVal pSucesion As String, _
                      ByVal pnum_orden As Integer, _
                      ByVal pnum_idenben As String, _
                      ByVal pgls_direccion As String, _
                      ByVal pcod_direccion As Integer, _
                      ByVal pPension_cal As Double, _
                      ByVal pcod_tippension As String, _
                      ByVal pgls_nomben As String, _
                      ByVal pgls_nomsegben As String, _
                      ByVal pgls_patben As String, _
                      ByVal pgls_matben As String, _
                      ByVal pcod_usuario As String, _
                      ByVal ppens_no_pagadas As Double, _
                      ByVal ppens_fut_no_pagadas As Double) As Boolean


On Error GoTo GestionError

        Registra_Endoso = False
       ...
       objCmd.CommandText = "Pkg_EndososHerencia.Reg_EndosoHerencia"
       objCmd.CommandType = adCmdStoredProc
       
        Set param1 = objCmd.CreateParameter("pnum_poliza", adVarChar, adParamInput, 10, pnum_poliza)
        objCmd.Parameters.Append param1
                
        Set param2 = objCmd.CreateParameter("pnum_memo", adVarChar, adParamInput, 10, pmemo)
        objCmd.Parameters.Append param2
        
        Set param3 = objCmd.CreateParameter("pnum_endoso", adInteger, adParamInput)
        param3.Value = pnum_endoso
        objCmd.Parameters.Append param3
        
        Set param4 = objCmd.CreateParameter("pnum_perpago", adVarChar, adParamInput, 6, pnum_perpago)
        objCmd.Parameters.Append param4
        
        Dim vfechaSol As String
        vfechaSol = Mid(pfecha_sol, 7, 4) + Mid(pfecha_sol, 4, 2) + Mid(pfecha_sol, 1, 2)
            
        Set param5 = objCmd.CreateParameter("pfecha_sol", adVarChar, adParamInput, 8, vfechaSol)
        objCmd.Parameters.Append param5
        
        Dim vfechaPago As String
        vfechaPago = Mid(pfecha_pago, 7, 4) + Mid(pfecha_pago, 4, 2) + Mid(pfecha_pago, 1, 2)
        
        Set param6 = objCmd.CreateParameter("pfecha_pago", adVarChar, adParamInput, 8, vfechaPago)
        objCmd.Parameters.Append param6
        
        Set param7 = objCmd.CreateParameter("pPension_cal", adDouble, adParamInput)
        param7.Value = pPension_cal
        objCmd.Parameters.Append param7
        
        Set param8 = objCmd.CreateParameter("pSucesion", adVarChar, adParamInput, 300, pSucesion)
        objCmd.Parameters.Append param8
        
        Set param9 = objCmd.CreateParameter("pnum_orden", adInteger, adParamInput)
        param9.Value = pnum_orden
        objCmd.Parameters.Append param9
        
        Set param10 = objCmd.CreateParameter("pnum_idenben", adVarChar, adParamInput, 16, pnum_idenben)
        objCmd.Parameters.Append param10
        
        
        Set param11 = objCmd.CreateParameter("pgls_direccion", adVarChar, adParamInput, 120, pgls_direccion)
        objCmd.Parameters.Append param11
        
        
        Set param12 = objCmd.CreateParameter("pcod_direccion", adInteger, adParamInput)
        param12.Value = pcod_direccion
        objCmd.Parameters.Append param12
        
        
        Set param13 = objCmd.CreateParameter("pcod_tippension", adVarChar, adParamInput, 5, pcod_tippension)
        objCmd.Parameters.Append param13
        
        Set param14 = objCmd.CreateParameter("pgls_nomben", adVarChar, adParamInput, 50, pgls_nomben)
        objCmd.Parameters.Append param14
        
        Set param15 = objCmd.CreateParameter("pgls_nomsegben", adVarChar, adParamInput, 50, pgls_nomsegben)
        objCmd.Parameters.Append param15
        
        Set param16 = objCmd.CreateParameter("pgls_patben", adVarChar, adParamInput, 50, pgls_patben)
        objCmd.Parameters.Append param16
        
        Set param17 = objCmd.CreateParameter("pgls_matben", adVarChar, adParamInput, 50, pgls_matben)
        objCmd.Parameters.Append param17
        
        Set param18 = objCmd.CreateParameter("pcod_usuario", adVarChar, adParamInput, 10, pcod_usuario)
        objCmd.Parameters.Append param18
    
        Set param19 = objCmd.CreateParameter("ppens_no_pagadas", adDouble, adParamInput)
        param19.Value = ppens_no_pagadas
        objCmd.Parameters.Append param19
        
        Set param20 = objCmd.CreateParameter("ppens_fut_no_pagadas", adDouble, adParamInput)
        param20.Value = ppens_fut_no_pagadas
        objCmd.Parameters.Append param20
...
Private Function Actualiza_Endoso(ByVal pnum_poliza As String, _
                                  ByVal pto_pensioncal As Double, _
                                  ByVal pfecha_sol As String, _
                                  ByVal pfecha_pago As String, _
                                  ByVal ppens_no_pagadas As Double, _
                                  ByVal ppens_fut_no_pagadas As Double, _
                                  ByVal pcod_usuario As String)
                                  
On Error GoTo GestionError

    Actualiza_Endoso = False
    ...
    Set objCmd = New ADODB.Command
     ...
     conn.Open
       ...
       objCmd.CommandText = "Pkg_EndososHerencia.Update_endHerencia"
       objCmd.CommandType = adCmdStoredProc
       
       Set param1 = objCmd.CreateParameter("pnum_poliza", adVarChar, adParamInput, 10, pnum_poliza)
       objCmd.Parameters.Append param1
       
        Set param2 = objCmd.CreateParameter("pto_pensioncal", adDouble, adParamInput)
        param2.Value = pto_pensioncal
        objCmd.Parameters.Append param2
        
        Dim vfechaSol As String
        vfechaSol = Mid(pfecha_sol, 7, 4) + Mid(pfecha_sol, 4, 2) + Mid(pfecha_sol, 1, 2)
            
        Set param3 = objCmd.CreateParameter("pfecha_sol", adVarChar, adParamInput, 8, vfechaSol)
        objCmd.Parameters.Append param3
        
        Dim vfechaPago As String
        vfechaPago = Mid(pfecha_pago, 7, 4) + Mid(pfecha_pago, 4, 2) + Mid(pfecha_pago, 1, 2)
        
        Set param4 = objCmd.CreateParameter("pfecha_pago", adVarChar, adParamInput, 8, vfechaPago)
        objCmd.Parameters.Append param4
        
        Set param5 = objCmd.CreateParameter("ppens_no_pagadas", adDouble, adParamInput)
        param5.Value = ppens_no_pagadas
        objCmd.Parameters.Append param5
        
        Set param6 = objCmd.CreateParameter("ppens_fut_no_pagadas", adDouble, adParamInput)
        param6.Value = ppens_fut_no_pagadas
        objCmd.Parameters.Append param6
        
        Set param7 = objCmd.CreateParameter("pcod_usuario", adVarChar, adParamInput, 10, pcod_usuario)
        objCmd.Parameters.Append param7
...
End Sub
Sub Getdatos_endosoHerencia(ByVal sNum_poliza As String)
...
vg_tipo_busqueda = p_tipo_busqueda
 ...
 vgSql = " SELECT a.num_poliza, a.num_endoso,a.num_orden, a.num_idenben, a.cod_tipoidenben,a.gls_nomben, a.gls_nomsegben, a.gls_patben, "
 vgSql = vgSql & " a.gls_matben, a.cod_grufam, a.cod_par, p.cod_moneda, a.cod_sexo, a.cod_sitinv,a.cod_dercre, a.cod_derpen, a.fec_nacben, "
 vgSql = vgSql & " a.mto_pensiongar, a.cod_estpension, a.fec_inipagopen, a.fec_terpagopengar, a.prc_pensiongar, a.gls_telben2,  a.cod_direccion, "
 vgSql = vgSql & " a.gls_dirben, a.gls_fonoben, a.gls_correoben, a.mto_pension, a.cod_MotReqPen, a.prc_pension, "
 vgSql = vgSql & " p.num_mesgar/12 per_garantizado FROM pp_tmae_ben a join pp_tmae_poliza p  on a.num_poliza = p.num_poliza "
 vgSql = vgSql & " and a.num_endoso = p.num_endoso and a.num_orden = 1 where a.num_poliza = '" & Txt_PenPoliza.Text & "'"
 vgSql = vgSql & " and a.num_endoso = (SELECT MAX(num_endoso) as numero From pp_tmae_ben where num_poliza = '" & Txt_PenPoliza.Text & "')"
...
Set vgRs2 = vgConexionBD.Execute(vgSql)
    Do While Not vgRs2.EOF
        ...
        txtPer_garantizado = IIf(IsNull(vgRs2!per_garantizado), "0", vgRs2!per_garantizado)
...
' End If
 ...
 Txt_PenNumIdent.Enabled = False
    ...
    Me.txtmto_pensioncal.SetFocus
    Me.txtgls_docjud.Text = FormatDateTime(Now, vbShortDate)
    Me.TxtFecPago.Text = FormatDateTime(Now, vbShortDate)
...
Call cargaDatos_Herencia(Txt_PenPoliza)
End Sub
...
txtgls_docjud.Text = ""
TxtFecPago.Text = ""
txtSucesionIntes.Text = ""
txtMemo.Text = ""
txtnopagadas.Text = ""
txtfuturasnopagadas.Text = ""

Me.dtFechaini = FormatDateTime(Now, vbShortDate)
Me.dtFechafin = FormatDateTime(Now, vbShortDate)
...
Sub Limpiar()
     ...
     txtPer_garantizado = ""
        ...
        txtnopagadas.Text = "0.00"
        txtfuturasnopagadas.Text = "0.00"
...
Private Sub cmdAceptaRangFecha_Click()

    
    Dim vFechaIni As String
    Dim vfechaFin As String
    
    vFechaIni = Format(Me.dtFechaini.Value, "yyyymmdd")
    vfechaFin = Format(Me.dtFechafin.Value, "yyyymmdd")
    
    Call ExportaEndosos(vFechaIni, vfechaFin)
    
End Sub
Private Sub ExportaEndosos(ByVal sDesde As String, ByVal sHasta As String)

     Call ReporteDatos_Herencia(sDesde, sHasta)
       ...
       If ((Not oDat) = -1) Then
            ...
            MsgBox "No hay registros para mostrar", vbExclamation, "Reporte de Endosos"
            Exit Sub
    ...
    Titulos(1) = "ENDOSO"
    Titulos(2) = "DNI"
    Titulos(3) = "NOMBRES DEL TITULAR"
    Titulos(4) = "MONTO LIQUIDAR"
    Titulos(5) = "FECHA SOLICITADA"
    Titulos(6) = "FECHA PAGO"
    Titulos(7) = "USUARIO"
  '  Titulos(8) = "SUCESION INTESTADA"
    Titulos(8) = "MEMO DE PAGO"
    Titulos(9) = "ESTADO"
    Titulos(10) = "FECHA CREACION"

    vFila = 1
    Obj_Hoja.Cells(vFila, 1) = "ENDOSOS POR HERENCIA "
    Obj_Hoja.rows(vFila).Font.Bold = True
    vFila = 2
    
    Obj_Hoja.Cells(vFila, 1) = "Periodo: " & Me.dtFechaini.Value & " - " & Me.dtFechafin.Value
    Obj_Hoja.rows(vFila).Font.Bold = True
    ...
    vTotaReg = UBound(oDat) + 1
 
    BarraProgreso.Value = 0
    BarraProgreso.Max = vTotaReg

    Obj_Hoja.Columns("A:D").NumberFormat = "@"
    Obj_Hoja.Columns("E").NumberFormat = "###,##0.00"
    Obj_Hoja.Columns("F:J").NumberFormat = "@"
     
    For i = 0 To UBound(oDat)
         vFila = vFila + 1
         Obj_Hoja.Cells(vFila, 1) = oDat(i).num_poliza
         Obj_Hoja.Cells(vFila, 2) = oDat(i).num_endoso
         Obj_Hoja.Cells(vFila, 3) = oDat(i).Num_IdenBen
         Obj_Hoja.Cells(vFila, 4) = oDat(i).nombres
         Obj_Hoja.Cells(vFila, 5) = oDat(i).mto_pensioncal
         Obj_Hoja.Cells(vFila, 6) = oDat(i).fecha_solicita
         Obj_Hoja.Cells(vFila, 7) = oDat(i).fec_pago
         Obj_Hoja.Cells(vFila, 8) = oDat(i).Cod_UsuarioCrea
       ' Obj_Hoja.Cells(vFila, 9) = oDat(i).sucesion
         Obj_Hoja.Cells(vFila, 9) = oDat(i).cod_memo
         Obj_Hoja.Cells(vFila, 10) = oDat(i).Estado
         Obj_Hoja.Cells(vFila, 11) = oDat(i).fecha_crea
         
      
      BarraProgreso.Value = vFila - 4
      lblMensaje.Caption = "Procesando " & BarraProgreso.Value & " de " & vTotaReg & " Registros."
      Me.Refresh
    ...
    Next
     ...
     Obj_Hoja.Range("A3:K3").Borders.LineStyle = xlContinuous
     Obj_Hoja.Range("A3:K3").Interior.Color = RGB(0, 32, 96)
     Obj_Hoja.Range("A3:K3").Font.Color = RGB(237, 125, 49)
     Obj_Hoja.Range("A3:K3").RowHeight = 34.5
     Obj_Hoja.Range("A3:K3").VerticalAlignment = xlVAlignCenter
     
    
   Obj_Hoja.Columns("A:K").AutoFit
...
'       Me.lblfinexcel.Caption = Format((CDate(lblinicio.Caption) - CDate(lblfinexcel.Caption)), "hh:mm:ss")
    ...
    Me.frm_rangoFechas.Visible = False
...
Private Sub cmdRpt_Click()
    Me.frm_rangoFechas.Visible = True
End Sub
...
'    fgComboGeneral vgCodTabla_AFP, cmbAfpBen
   ...
   Me.txtmto_pensioncal.Text = "0.00"
...
If vlExiste <> 0 Then
    ...
    vgSql = vgSql & " select num_poliza,num_endoso + 1 ,'" & Format(CDate(txtgls_docjud.Text), "yyyymmdd") & "','" & vlFecCrea & "','29','S',mto_diferencia,cod_moneda," & txtmto_pensioncal.Text & "," & txtmto_pensioncal.Text & ",'" & vlFecCrea & "',prc_factor,'" & txtSucesionIntes.Text & "',"
...
Else
    vgSql = " insert into PP_TMAE_ENDOSO "
    vgSql = vgSql & " select num_poliza,1,'" & Format(CDate(txtgls_docjud.Text), "yyyymmdd") & "','" & vlFecCrea & "','29', 'S', 0, cod_moneda," & txtmto_pensioncal.Text & "," & txtmto_pensioncal.Text & ",'" & vlFecCrea & "', 0,'" & txtSucesionIntes.Text & "',"
...
vgSql = vgSql & ", '" & Format(CDate(Me.TxtFecPago.Text), "yyyymmdd") & "'"
vgSql = vgSql & ", '" & "04" & "'"
...
Function fl_aprobar(ByVal SwRegNuevo As Boolean) As Boolean
On Error GoTo Err_Aprobar
   ...
   vlcod_tippension = Trim(Mid(Cmb_PMTipPen, 1, (InStr(1, Cmb_PMTipPen, "-") - 1)))
    ...
    If SwRegNuevo Then
         ...
         fl_aprobar = Registra_Endoso(Txt_PenPoliza.Text, txtMemo.Text, Lbl_EndosoActual, Format(Date, "yyyymm"), _
                        txtgls_docjud.Text, TxtFecPago.Text, txtSucesionIntes.Text, 1, Txt_PenNumIdent, _
                        vlxgls_dirben, vlxcod_direccion, txtmto_pensioncal.Text, vlcod_tippension, vlxgls_nomben, _
                        vlxgls_nomsegben, vlxgls_patben, vlxgls_matben, vgUsuario, txtnopagadas.Text, txtfuturasnopagadas)
     Else
        fl_aprobar = Actualiza_Endoso(Txt_PenPoliza.Text, txtmto_pensioncal.Text, _
        txtgls_docjud.Text, TxtFecPago.Text, txtnopagadas.Text, txtfuturasnopagadas, vgUsuario)
...
'    vgConectarBD.Close
  ...
  '  Call Registra_memo(Txt_PenPoliza.Text, txtMemo.Text, txtnopagadas.Text, txtfuturasnopagadas.Text)
...
On Error GoTo Err_flImprimirEndosoDef
   ...
   vlArchivo = strRpt & "PP_Rpt_EndDefEnHerencia.rpt"   '\Reportes
...
'RRR
   ...
   End If
    ...
    Dim Vpen_no_pagadas As Double
    Dim Vpen_futuras_no_pagadas As Double
    
   'Call GetPensiones(vlGlobalNumPoliza, Vpen_no_pagadas, Vpen_futuras_no_pagadas)
   
   

    If objRep.CargaReporte(strRpt & "", "PP_Rpt_EndDefEnHerencia.rpt", "Informe de Liquidación de Rentas Vitalicias", rsLiq, True, _
                            ...
                            ArrFormulas("CodMonedaCor", vlImpCodMoneda), ArrFormulas("FlgSRPT", 0), _
                            ArrFormulas("Pens_no_pag", oDat(0).Pens_no_pagadas), ArrFormulas("Pens_futno_pag", oDat(0).Pens_futuras_no_pagadas)) = False Then
...
End Function
Private Sub GetPensiones(ByVal pnum_poliza As String, ByRef vPens_no_pagadas As Double, ByRef vPens_futuras_no_pagadas As Double)
        cargaDatos_Herencia (pnum_poliza)
               ...
               Else
                    ...
                    vPens_no_pagadas = oDat(0).Pens_no_pagadas
                    vPens_futuras_no_pagadas = oDat(0).Pens_futuras_no_pagadas
               End If
...
Private Sub TxtFecPago_GotFocus()
    Call Foco(TxtFecPago)
End Sub

Private Sub TxtFecPago_LostFocus()
    If Not IsDate(Me.TxtFecPago.Text) And Trim(TxtFecPago.Text) <> "" Then
        MsgBox "La fecha ingresada no es válida, por favor corregir.", vbInformation, "SEACSA Pensiones"
        Exit Sub
    End If
End Sub
Private Sub txtfuturasnopagadas_LostFocus()
     If Not IsNumeric(txtfuturasnopagadas) And Trim(txtfuturasnopagadas.Text) <> "" Then
        MsgBox "El valor ingresado en pensionnes futuras no pagadas no es válido, por favor corregir.", vbInformation, "SEACSA Pensiones"
        Exit Sub
    Else
        txtfuturasnopagadas = sacapuntos(txtfuturasnopagadas.Text)
        If Not IsNumeric(txtfuturasnopagadas) Then
            MsgBox "El valor ingresado en pensionnes futuras no pagadas no es válido, por favor corregir.", vbInformation, "SEACSA Pensiones"
            txtfuturasnopagadas.Text = "0.00"
            txtfuturasnopagadas.SetFocus
            Exit Sub
        End If
    End If
End Sub

Private Sub txtgls_docjud_GotFocus()
    Call Foco(txtgls_docjud)
End Sub

Private Sub txtgls_docjud_LostFocus()
    If Not IsDate(Me.txtgls_docjud.Text) And Trim(txtgls_docjud.Text) <> "" Then
        MsgBox "La fecha ingresada no es válida, por favor corregir.", vbInformation, "SEACSA Pensiones"
        Exit Sub
    End If
End Sub

Private Sub txtmto_pensioncal_GotFocus()
    Call Foco(txtmto_pensioncal)
End Sub

Private Sub txtmto_pensioncal_LostFocus()
    If Not IsNumeric(txtmto_pensioncal) And Trim(txtmto_pensioncal.Text) <> "" Then
        MsgBox "El valor ingresado en monto a liquidar no es válido, por favor corregir.", vbInformation, "SEACSA Pensiones"
        Exit Sub
    Else
        txtmto_pensioncal = sacapuntos(txtmto_pensioncal.Text)
        If Not IsNumeric(txtmto_pensioncal) Then
            MsgBox "El valor ingresado en monto a liquidar no es válido, por favor corregir.", vbInformation, "SEACSA Pensiones"
            txtmto_pensioncal.Text = "0.00"
            txtmto_pensioncal.SetFocus
            Exit Sub
        End If
    End If
...
Dim Comilla As String
    ...
    While InStr(cadena, ",") > 0
        intPosComa = InStr(cadena, ",")
    
        If intPosComa >= Len(cadena) - 2 Then
    ...
    sacapuntos = cadena
End Function
Private Sub ReporteDatos_Herencia(ByVal pFecha_ini As String, _
                                  ByVal pFecha_Fin As String)
                ...
                objCmd.CommandText = "Pkg_EndososHerencia.Obtener_endosoXFechas"
                objCmd.CommandType = adCmdStoredProc
                
                Set param1 = objCmd.CreateParameter("pFecha_ini", adVarChar, adParamInput, 10, pFecha_ini)
                objCmd.Parameters.Append param1
                
                Set param2 = objCmd.CreateParameter("pFecha_fin", adVarChar, adParamInput, 10, pFecha_Fin)
                objCmd.Parameters.Append param2
                ...
                If rs.RecordCount > 0 Then
                    ...
                    While Not rs.EOF
                      i = i + 1
                          ...
                          oDat(i).sucesion = IIf(IsNull(rs!sucesion), "", rs!sucesion)
                          oDat(i).cod_memo = IIf(IsNull(rs!cod_memo), "", rs!cod_memo)
                          oDat(i).fecha_crea = IIf(IsNull(rs!Fec_Crea), "", rs!Fec_Crea)
...
End Sub
Private Sub txtnopagadas_LostFocus()
 If Not IsNumeric(txtnopagadas) And Trim(txtnopagadas.Text) <> "" Then
        MsgBox "El valor ingresado en pensiones no pagadas no es válido, por favor corregir.", vbInformation, "SEACSA Pensiones"
             txtnopagadas.Text = "0.00"
            txtnopagadas.SetFocus
        Exit Sub
    Else
        txtnopagadas = sacapuntos(txtnopagadas.Text)
        If Not IsNumeric(txtnopagadas) Then
            MsgBox "El valor ingresado en pensiones no pagadas no es válido, por favor corregir.", vbInformation, "SEACSA Pensiones"
            txtnopagadas.Text = "0.00"
            txtnopagadas.SetFocus
            Exit Sub
